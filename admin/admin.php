            ...
            <div class="container-fluid py-1 px-3">
               ...
               <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                  ...
                  <ul class="navbar-nav  justify-content-end">
                     <li class="mt-2">
                        <!-- <a class="github-button" href="https://github.com/creativetimofficial/material-dashboard" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star creativetimofficial/material-dashboard on GitHub"></a>-->
                     </li>
                     ...
                     <div class="col-10">
                        <div class="card mb-4 ">
                           <div class="d-flex">
                              ...
                              <h6 class="mt-3 mb-2 ms-3 "> Top 5 Bookings by States</h6>
                           </div>
                           <div class="card-body p-3">
                              <div class="row">
                                          ...
                                          <tbody>
                                             <tr>
                                                <td class="w-30">
                                                   <div class="d-flex px-2 py-1 align-items-center">
                                                      <div>
                                                         <img src="./assets/img/icons/flags/US.jpeg" alt="Country flag">
                                                      </div>
                                                      <div class="ms-4">
                                                         <p class="text-xs font-weight-bold mb-0 ">State:</p>
                                                         <h6 class="text-sm font-weight-normal mb-0 ">Gujarat</h6>
                                                      </div>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div class="text-center">
                                                      <p class="text-xs font-weight-bold mb-0 ">Bookings:</p>
                                             ...
                                             <tr>
                                                <td class="w-30">
                                                   <div class="d-flex px-2 py-1 align-items-center">
                                                      <div>
                                                         <img src="./assets/img/icons/flags/DE.jpg" alt="Country flag">
                                                      </div>
                                                      <div class="ms-4">
                                                         <p class="text-xs font-weight-bold mb-0 ">State:</p>
                                                         <h6 class="text-sm font-weight-normal mb-0 ">Rajasthan</h6>
                                                      </div>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div class="text-center">
                                                      <p class="text-xs font-weight-bold mb-0 ">Bookings:</p>
                                                      <h6 class="text-sm font-weight-normal mb-0 ">3900</h6>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div class="text-center">
                                             ...
                                             <tr>
                                                <td class="w-30">
                                                   <div class="d-flex px-2 py-1 align-items-center">
                                                      <div>
                                                         <img src="./assets/img/icons/flags/GB.jpg" alt="Country flag">
                                                      </div>
                                                      <div class="ms-4">
                                                         <p class="text-xs font-weight-bold mb-0 ">State:</p>
                                                         <h6 class="text-sm font-weight-normal mb-0 ">Haryana</h6>
                                                      </div>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div class="text-center">
                                                      <p class="text-xs font-weight-bold mb-0 ">Bookings:</p>
                                                      <h6 class="text-sm font-weight-normal mb-0 ">1400</h6>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div class="text-center">
                                             ...
                                             <tr>
                                                <td class="w-30">
                                                   <div class="d-flex px-2 py-1 align-items-center">
                                                      <div>
                                                         <img src="./assets/img/icons/flags/BR.jpg" alt="Country flag">
                                                      </div>
                                                      <div class="ms-4">
                                                         <p class="text-xs font-weight-bold mb-0 ">State:</p>
                                                         <h6 class="text-sm font-weight-normal mb-0 ">Maharashtra</h6>
                                                      </div>
                                                   </div>
                                                </td>
                                                <td>
                        ...
                        <div class="container border-radius-lg">
                           <div class="row">
                              ...
                              <div class="col-3 py-3 ps-0">
                                 ...
                                 <h4 class="font-weight-bolder">99K</h4>
                                 <div class="progress w-75">
                              ...
                              <div class="col-3 py-3 ps-0">
                                 <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Bookings</p>
                                 </div>
                              ...
                              <div class="col-3 py-3 ps-0">
                                 <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Materials</p>
                                 </div>
                  ...
                  <div class="row align-items-center justify-content-lg-between">
                     <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                           ...
                           <a href="" class="font-weight-bold" target="_blank">R.K Cargo</a>
                        </div>
                     </div>
                     <!--<div class="col-lg-6">
         ...
         <div class="card shadow-lg">
            ...
            <div class="card-body pt-sm-3 pt-0">
               ...
               <!--<hr class="horizontal dark my-sm-4">
                  ...
                  <a class="btn btn-outline-dark w-100" href="https://www.creative-tim.com/learning-lab/bootstrap/overview/material-dashboard"></a>
